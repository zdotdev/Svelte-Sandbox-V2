<script>
    import { createEventDispatcher } from 'svelte' /* event dispatcher allows you to create a custon naming for an 
    event */
...
<button on:click={() => {data++}} class="bg-slate-200 p-2 rounded-lg w-fit">Switch</button>